...
#%% 
    def cargarSenial(self):
        ...
        self.dialog = Dialog(str(len(self.rutas)) + ' File(s) loaded', os.path.join(img_path, 'open.png'))
        self.dialog.show()
        self.list3.addItem('')
...
#%%
    def MDFA(self):
            ...
            self.dialogo_done = Dialog('Done!!', os.path.join(img_path, 'listo.png'))
...
#%%
    def initUI(self):
        ...
        self.setWindowIcon(QIcon(os.path.join(img_path, 'MDFA.png')))
        ########Variables Globales ####################################################
        ###############################################################################        
        self.rutas = None
        self.nombreSenial=''
