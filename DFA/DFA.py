...
#%%
    def cargarSenial1(self):
        ...
        self.dialog = Dialog(str(len(self.rutas))+' Files(s) loaded',r'./img/open.png')
        self.dialog.show()
        self.list3.addItem('')
...
#%% 
    def DFA1(self): 
        ...
        self.dialog = Dialog('Done!!','./img/listo.png')
        self.dialog.show()
...
############################################################################### 
        ...
        ruta_icono = os.path.join(os.path.dirname(os.path.abspath(__file__)), "img", "DFA.png")
